...
/**
 * Class and JSON object for all data that is fetched from the endpoint in {@link DefaultsFetcher}.
 */
@Getter
@Setter
public class FieldDefaults {
    ...
    /**
     * Creates a new object for all data that is fetched from the endpoint in {@link DefaultsFetcher}.
     * Default constructor, assigns the values from {@link FieldDefaults#DEFAULT_VALUES}.
     */
     ...
     */
    public FieldDefaults(String newestVersion,
                         String defaultFilenameProg,
                         String defaultFilenameAlgo,
                         String defaultMailTitleProg,
    ...
    /**
     * Creates a new object for all data that is fetched from the endpoint in {@link DefaultsFetcher}.
     * Creates a copy of the given {@link FieldDefaults}.
     *
    ...
    public static final FieldDefaults DEFAULT_VALUES = new FieldDefaults(
            System.getProperty("version"),
            DEFAULT_PDF_NAME_FORMAT,
            DEFAULT_PDF_NAME_FORMAT,
            "Stundenzettel %FIRST% %LAST% %YYYY%-%MM%",
