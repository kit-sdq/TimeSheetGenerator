...
public class TimeSheetArithmeticTest {
    ...
    public void testGetTotalWorkTime() {
        ...
        entries[2] = new Entry("Test3", LocalDate.now(), new ClockTime(10, 0), new ClockTime(12, 0), new TimeSpan(0, 15), false);
        entries[3] = new Entry("Test4", LocalDate.now(), new ClockTime(15, 0), new ClockTime(16, 30), new TimeSpan(0, 0), false);
