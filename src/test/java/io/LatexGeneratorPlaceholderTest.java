...
public class LatexGeneratorPlaceholderTest {
    ...
    private static Stream<Arguments> getTemplateAndExpected() {
        return Stream.of(
                Arguments.of("Year: !year", "Year: 2019"),
                Arguments.of("Month: !month", "Month: 11"),
                Arguments.of("Employee Name: !employeeName", "Employee Name: Max Mustermann"),
                Arguments.of("Employee ID: !employeeID", "Employee ID: 1234567"),
                Arguments.of("GF / UB: !workingArea", "GF / UB: \\textbf{GF:} $\\Box$ \\textbf{UB:} $\\boxtimes$"),
                Arguments.of("Department: !department", "Department: Fakultät für Informatik"),
                Arguments.of("Max Hours: !workingTime", "Max Hours: 40:00"),
                Arguments.of("Wage: !wage", "Wage: 10.31"),
                Arguments.of("Vacation: !vacation", "Vacation: 02:30"),
                Arguments.of("Hours: !sum", "Hours: 10:00"),
                Arguments.of("Transfer Pred: !carryPred", "Transfer Pred: 02:00"),
                Arguments.of("Transfer Succ: !carrySucc", "Transfer Succ: 01:00"),
                ...
                Arguments.of("End 1: !end, End 2: !end, End 3: !end, End 4: !end",
