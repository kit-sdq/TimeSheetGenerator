...
public class LatexGeneratorPlaceholderTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            ...
            {"Action 1: !action, Action 2: !action", "Action 1: Test Action 1, Action 2: Test Action 2"},
            {"Date 1: !date, Date 2: !date",
                "Date 1: " + LocalDate.of(2019, 11, 12).format(DATE_TIME_FORMATTER) +
                ", Date 2: " + LocalDate.of(2019, 11, 14).format(DATE_TIME_FORMATTER)},
            {"Start 1: !begin, Start 2: !begin", "Start 1: 10:00, Start 2: 08:00"},
            {"End 1: !end, End 2: !end", "End 1: 14:00, End 2: 12:00"},
            {"Pause 1: !break, Pause 2: !break", "Pause 1: 00:30, Pause 2: 00:00"},
            {"Time 1: !dayTotal, Time 2: !dayTotal", "Time 1: 03:30, Time 2: 04:00"}
        });
    }
    ...
    public LatexGeneratorPlaceholderTest(final String template, final String expected) {
        ...
        Entry entry0 = new Entry("Test Action 1", YEAR_MONTH.atDay(12), new TimeSpan(10, 0), new TimeSpan(14, 0), new TimeSpan(0, 30));
        Entry entry1 = new Entry("Test Action 2", YEAR_MONTH.atDay(14), new TimeSpan(8, 0), new TimeSpan(12, 0), new TimeSpan(0, 0));
        Entry[] entries = new Entry[] {entry0, entry1};
        this.timeSheet = new TimeSheet(EMPLOYEE, PROFESSION, YEAR_MONTH, entries, new TimeSpan(2, 30), new TimeSpan(1, 0), new TimeSpan(2, 0));
    }
