...
public class Month {
    ...
    public static class Entry {
        ...
        public String getPause() { return pause; }
        public void setPause(String pause) { this.pause = pause; }
    ...
    public String getPredTransfer() { return predTransfer; }
    public void setPredTransfer(String predTransfer) { this.predTransfer = predTransfer; }

    public String getSuccTransfer() { return succTransfer; }
    public void setSuccTransfer(String succTransfer) { this.succTransfer = succTransfer; }
